...
dfPosicao_CPR.loc[dfPosicao_CPR['aliasoperacao_x'].str.find('JUSTE CONTÁBIL',1)>0 ,'nome'] = 'Outras Despesas'
...
# a = dfCustodiaAutomatica[dfCustodiaAutomatica['cgc'] =='11435287000107']
# a = a[a['aliasativo'] =='SPOT#BRLOTC@REAL']
# b = dfPosicao_CPR[dfPosicao_CPR['cgc'] =='11435287000107']
# b = b[b['aliasativo'] =='SPOT#BRLOTC@REAL']
