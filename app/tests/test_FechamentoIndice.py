...
from app.classes.cl_FechamentoIndice import cl_FechamentoIndice
import pytest
...
class TestFechamentoIndice:

    @pytest.fixture()
    def test_object(self):return cl_FechamentoIndice(**{})
...
################# Expecificidade desta Classe #########################            
            setattr(test_object, 'idIndice', 1)
################# Expecificidade desta Classe #########################          
