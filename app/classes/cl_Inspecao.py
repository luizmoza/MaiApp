...
class cl_Inspecao(app.base):
    idInspecao:Mapped[int] = mapped_column(primary_key=True,unique=True)
    ...
    def __init__(self,**kwargs): 
        self.idInspecao = kwargs['idInspecao'] if 'idInspecao' in kwargs else None
        self.idControle = kwargs['idControle'] if 'idControle' in kwargs else None
        self.Gatilho = kwargs['Gatilho'] if 'Gatilho' in kwargs else None
