...
class cl_Fluxo(app.base):
    IDFluxo:Mapped[int] = mapped_column(primary_key=True,unique=True)	
    CodigoRF:Mapped[str]	
    ValorLiq:Mapped[float]	
    TaxaEvento:Mapped[float]	
    PercEvento:Mapped[float]	
    TipoIncidencia:Mapped[str]
    TipoEvento:Mapped[str]
    idRf:Mapped[int]	
    ...
    def  __init__(self,**kwargs): 
        self.IDFluxo = kwargs['IDFluxo'] if 'IDFluxo' in kwargs else None
        self.CodigoRF = kwargs['CodigoRF'] if 'CodigoRF' in kwargs else None
        self.ValorLiq = kwargs['ValorLiq'] if 'ValorLiq' in kwargs else None
        self.TaxaEvento = kwargs['TaxaEvento'] if 'TaxaEvento' in kwargs else None
        self.PercEvento = kwargs['PercEvento'] if 'PercEvento' in kwargs else None	
        self.TipoIncidencia = kwargs['TipoIncidencia'] if 'TipoIncidencia' in kwargs else None
        self.TipoEvento = kwargs['TipoEvento'] if 'TipoEvento' in kwargs else None
