...
dictNotMTM = app.pd.read_excel(r"../Novo_Gerencial_manhaD_2.xlsm", 'Aux',skiprows=[0])
dfData = app.pd.read_excel(r"../Novo_Gerencial_manhaD_2.xlsm", 'Dt_Param',skiprows=[0])
dfRendimentos = app.pd.read_excel(r"../Novo_Gerencial_manhaD_2.xlsm", 'QTLink')
dflistacgcs = app.pd.read_excel(r"../Novo_Gerencial_manhaD_2.xlsm", 'Lista_CGCs',skiprows=[0])
...
dfFinal.to_excel(r"../Current_PreGerencial_manhaD_2.xlsx", index=False)
############################################### Carga da Custodia e das Boletas D0 #############################################
################################################################################################################################
